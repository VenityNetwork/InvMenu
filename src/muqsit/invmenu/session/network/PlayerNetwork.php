...
final class PlayerNetwork{
	...
	private int $graphic_wait_duration = 50;
	...
	public function notify(int $timestamp) : void{
		if($this->current !== null && $timestamp === $this->current->timestamp * ($this->network_session->getProtocol() >= ProtocolInfo::PROTOCOL_594 ? 1000000 : 1)){
